                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-2 bg-zinc-900/70 rounded-md focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        />
                    </div>
                    ...
                    <button
                        ...
                        className={`w-full px-4 py-2.5 mb-3 font-medium text-white rounded-md ${side === "BUY" ? "bg-testbg hover:bg-testbg" : "bg-red-400 hover:bg-red-500"} focus:outline-none disabled:opacity-50`}
                    >
